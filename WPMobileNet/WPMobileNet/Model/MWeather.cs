...
namespace WPMobileNet.Model
{
    ...
    public class sys
    {
        ...
        public string sunriseString { get { return UnitConverter.UnixTimeStampToDateTime(sunrise).ToShortTimeString(); } }
        public double sunset { get; set; }
        public string sunsetString { get { return UnitConverter.UnixTimeStampToDateTime(sunset).ToShortTimeString(); } }
    }
