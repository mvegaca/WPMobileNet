...
namespace WPMobileNet.ViewModel
{
    public class VMInclinometer : VMBase
    {
        ...
        #region Constructors
        public VMInclinometer(NavigationService navigationService, InclinometerService inclinometerService)
        ...
        private void InclinometerServiceReadingChanged(object sender, Windows.Devices.Sensors.InclinometerReadingChangedEventArgs e)
        {
